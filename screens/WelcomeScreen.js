    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.bg }]}> 
      ...
      <View style={styles.content}>
        <Animated.View style={[
          ...
          <Text style={[styles.subtitle, { color: colors.textSecond }]}>Organize your subjects,{'\n'}tasks and deadlines.</Text>
        </Animated.View>
        <View style={styles.actions}>
          <TouchableOpacity style={[styles.primaryButton, { backgroundColor: colors.accent }]} onPress={() => navigation.navigate('Login')} activeOpacity={0.75}>
            <Text style={styles.primaryButtonText}>Sign in</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[styles.secondaryButton, { borderColor: colors.accent }]} onPress={() => navigation.navigate('Register')} activeOpacity={0.75}>
